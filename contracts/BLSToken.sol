...
contract BLSToken is ERC20Permit, Ownable {
    constructor() ERC20("BLSToken", "BLS") ERC20Permit("BLSToken") {}

    uint256 private constant _maxTotalSupply = 10000000e18; // 10,000,000 max BLS
